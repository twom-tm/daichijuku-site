    ...
    <>
      <main>
          ...
          <div className="container">
            <div className="hero-content fade-in">
              ...
              <div className="btn-group">
                <a href="#final-cta" className="btn btn--primary btn--lg">説明会を見る</a>
        ...
        <section className="section--navy final-cta" id="final-cta">
          <div className="container fade-in">
            ...
            <div className="btn-group">
              <a href="#" className="btn btn--white btn--lg">説明会を見る</a>
              <a href="https://line.me/R/ti/p/@817jyxon" target="_blank" rel="noopener"
      ...
      <div className="sticky-cta" id="stickyCta">
        <div className="sticky-cta-inner">
          <a href="#final-cta" className="btn btn--primary">説明会を見る</a>
